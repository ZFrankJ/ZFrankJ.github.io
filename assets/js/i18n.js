...
const entries = [
  { aliases: ["Fujia Zhang", "Fujia Zhang (张孚嘉)"], en: "Fujia Zhang · 张孚嘉", zh: "Fujia Zhang · 张孚嘉" },
  { aliases: ["© 2026 Fujia Zhang. All rights reserved."], en: "© 2026 Fujia Zhang · 张孚嘉. All rights reserved.", zh: "© 2026 Fujia Zhang · 张孚嘉。保留所有权利。" },
  ...
  { aliases: ["Fujia Zhang | Personal Website"], en: "Fujia Zhang · 张孚嘉 | Personal Website", zh: "Fujia Zhang · 张孚嘉 | 个人网站" },
  ["Science · Finance · Everything in between", "科学 · 金融 · 及两者之间的一切"],
  ["High school student exploring brain-inspired AI and quantitative trading.", "一名探索类脑人工智能与量化交易的高中生。"],
  ["Brain-inspired AI and quantitative trading", "类脑人工智能与量化交易"],
  ["Science · Neo Neuron: a new recurrent cell", "科学 · Neo 神经元：一种新的循环单元"],
  ["Designed and tested Neo, then audited the backend and aligned the baseline. On WikiText-103, the finalized study found no parameter-efficiency advantage over the aligned LSTM.", "设计并测试了 Neo，随后完成后端审计与基线对齐。最终的 WikiText-103 研究表明，相较于对齐后的 LSTM，Neo 并未展现出参数效率优势。"],
  ["Tech blog", "技术博客"],
  ["Paper (PDF)", "论文（PDF）"],
  ["Repository", "代码仓库"],
  ...
  { aliases: ["Fujia Zhang | Science"], en: "Fujia Zhang · 张孚嘉 | Science", zh: "Fujia Zhang · 张孚嘉 | 科学" },
  ["Brain-inspired AI, experiments in language&vision, and AI-based projects that build intuition.", "类脑人工智能、语言与视觉实验，以及用于培养直觉的 AI 项目。"],
  ...
  { aliases: ["Fujia Zhang | Finance"], en: "Fujia Zhang · 张孚嘉 | Finance", zh: "Fujia Zhang · 张孚嘉 | 金融" },
  ...
  ["My Wechat Blog (need English translation)", "我的微信公众号文章（尚需英文翻译）"],
  ...
  { aliases: ["Fujia Zhang | Profile"], en: "Fujia Zhang · 张孚嘉 | Profile", zh: "Fujia Zhang · 张孚嘉 | 个人简介" },
  ["How to reach me and what I’m most excited to talk about right now.", "我的联系方式，以及此刻最期待与你交流的话题。"],
  ["Fujia Zhang portrait", "Fujia Zhang · 张孚嘉的肖像"],
  ["Institution:", "学校："],
  ...
  ["Topics", "关注方向"],
  ["Brain-inspired AI, Quantitative trading and Vibe coding", "类脑人工智能、量化交易与随兴编程"],
  ["Aphorism", "格言"],
  ["“Deep Learning is the most important event of this age, but Learning Deeply is the most important event for all time.”", "“深度学习是这个时代最重要的事件，而深入学习是所有时代最重要的事。”"],
  ["Quick links", "快速链接"],
  ["Brain-inspired AI experiments.", "类脑人工智能实验。"],
  ...
  { aliases: ["Fujia Zhang | Others"], en: "Fujia Zhang · 张孚嘉 | Others", zh: "Fujia Zhang · 张孚嘉 | 其他" },
  ...
  { aliases: ["Fujia Zhang | Self-Cultivation Gallery"], en: "Fujia Zhang · 张孚嘉 | Self-Cultivation Gallery", zh: "Fujia Zhang · 张孚嘉 | 自我修行影集" },
  ...
  { aliases: ["Fujia Zhang | Self-Cultivation Notes"], en: "Fujia Zhang · 张孚嘉 | Self-Cultivation Notes", zh: "Fujia Zhang · 张孚嘉 | 自我修行随笔" },
  ["Journal notes by Fujia Zhang on consciousness, identity, attachment, and self-cultivation.", "Fujia Zhang · 张孚嘉关于意识、身份、执着与自我修行的随笔。"],
  ...
  { aliases: ["中文 / English"], en: "Chinese / English", zh: "中文 / 英文" },
  { aliases: ["中文"], en: "Chinese", zh: "中文" },
  { aliases: ["中文 · 摘录"], en: "Chinese · Excerpt", zh: "中文 · 摘录" },
  ["Read note →", "阅读随笔 →"],
  ...
  { aliases: ["向内求：一场迟来的自我修行 | Fujia Zhang", "Seeking Within: A Belated Journey of Self-Cultivation | Fujia Zhang"], en: "Seeking Within: A Belated Journey of Self-Cultivation | Fujia Zhang · 张孚嘉", zh: "向内求：一场迟来的自我修行 | Fujia Zhang · 张孚嘉" },
  ...
  ["Notion of Self", "我相"],
  { aliases: ["关于我相的进一步思考以及指导意义 | Fujia Zhang"], en: "Further Reflections on the Notion of Self | Fujia Zhang · 张孚嘉", zh: "关于我相的进一步思考以及指导意义 | Fujia Zhang · 张孚嘉" },
  ["Further reflections on the notion of self and its practical implications.", "关于我相的进一步思考以及指导意义。"],
  ["Journal entry — Thursday, May 28, 2026", "随笔记录 — 2026年5月28日，星期四"],
  ["Four Marks", "四相"],
  ["— An Excerpt from Another Writer", "—— 摘录他人语句"],
  ["(摘录他人语句)", "（摘录他人语句）"],
  { aliases: ["说破四相 | Fujia Zhang"], en: "Seeing Through the Four Marks | Fujia Zhang · 张孚嘉", zh: "说破四相 | Fujia Zhang · 张孚嘉" },
